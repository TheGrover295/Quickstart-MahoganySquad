...
@Configurable
@Autonomous(name = "Red Auto Shoot",  group = "Auto Tests")
public class AutoShootRed extends OpMode {
    ...
    // Poses
    private final Pose startPose = new Pose(81.99103139013452, 5.255605381165919, Math.toRadians(270));
    private final Pose shootPose = new Pose(73.117555372843, 29.627802690582957, Math.toRadians(600));
    private final Pose parkPose = new Pose(35.60089686098653, 8.820627802690584, Math.toRadians(100));
    ...
    private final double INITIAL_WAIT = 2.0;  // 5 second wait at shoot pos
