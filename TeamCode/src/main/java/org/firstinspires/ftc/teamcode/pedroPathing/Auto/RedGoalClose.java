...
@Configurable
@Autonomous(name = "Red Goal Auto Shoot", group = "AutoReal")
public class RedGoalClose extends OpMode {
    ...
    // Poses
    private final Pose startPose = new Pose(122.34977578475333, 121.48878923766814, Math.toRadians(220));
    private final Pose shootPose = new Pose(81.67360918450224, 80.64125560538116, Math.toRadians(230));
    private final Pose parkPose = new Pose(97.44843049327355, 70.83408071748877, Math.toRadians(230));
